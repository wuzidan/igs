...
const showSidebar = computed(() => {
  ...
  const excludedRouteNames = ['lyq', 'login', 'register', 'change-password', 'wechat-login', 'qq-login', 'other-login', 'student-index'];
  const excludedPaths = ['lyq ', '/login', '/register', '/change-password', '/wechat-login', '/qq-login', '/other-login', '/index', '/student/index'];
