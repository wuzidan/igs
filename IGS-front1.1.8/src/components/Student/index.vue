      ...
      <section v-if="!isTeacher">
          ...
          <div class="welcome-content">
            ...
            <div class="study-streak">
              <div class="streak-info">
                ...
                <span class="streak-value">{{ learningDays }}</span>
              </div>
              <div class="streak-info">
                <span class="streak-icon">🔥</span>
                <span class="streak-value">{{ continuousDays }}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="status-cards">
            ...
            <div id="completed-tasks" class="status-card">
              ...
              <div class="card-trend">
                <span class="trend-indicator">+{{ weeklyGrowth }}%</span>
            ...
            <div id="accuracy-rate" class="status-card">
              ...
              <div class="progress-container">
                <div class="progress-background"></div>
                <div class="progress-bar" :style="{ width: accuracyRate + '%' }"></div>
              </div>
              <div class="card-trend">
                <span class="trend-indicator">+{{ accuracyGrowth }}%</span>
            ...
            <div id="mastered-topics" class="status-card">
              ...
              <div class="card-stat">
                ...
                <span class="stat-total">/{{ totalTopics }}</span>
              </div>
              <div class="progress-container">
                <div class="progress-background"></div>
                <div class="progress-bar" :style="{ width: masteryRate + '%' }"></div>
              </div>
              <div class="card-trend">
                <span class="trend-indicator">+{{ newTopics }}</span>
            ...
            <div id="study-duration" class="status-card">
              ...
              <div class="card-stat">
                <span class="stat-value">{{ weeklyStudyHours }}</span>
                <span class="stat-unit">小时</span>
              </div>
              <div class="progress-container">
                <div class="progress-background"></div>
                <div class="progress-bar" :style="{ width: studyHoursRateStudent + '%' }"></div>
              </div>
              <div class="card-trend">
                <span class="trend-indicator">+{{ hoursIncrease }}</span>
                <span class="trend-text">较上周</span>
              </div>
            </div>
          </div>
        ...
        <section class="core-features">
          ...
          <div class="features-grid">
            <!-- 题库资源 -->
            <div class="feature-card floating-card" @click="navigateTo('/student/quiz-challenge')">
              ...
              <p class="feature-description">
                访问超过{{ questionBankCount }}道题目，涵盖多种题型和难度级别，随时进行练习。
              </p>
              <div class="feature-stats">
                <span class="feature-count">最近完成：{{ recentAnswers }}道</span>
                <span class="feature-badge">🔥推荐</span>
              </div>
            </div>

            <!-- 作答历史 -->
            <div class="feature-card floating-card" @click="navigateTo('/student/history')">
              <div class="feature-hover-effect"></div>
              <div class="feature-icon-container">
                <span class="feature-icon">📈</span>
              </div>
              ...
              <div class="feature-stats">
                <span class="feature-count">错误率：{{ errorRate }}%</span>
                <span class="feature-badge">📊数据</span>
              </div>
            </div>

            <!-- 状态可视化 -->
            <div class="feature-card floating-card" @click="navigateTo('/student/visualization')">
              <div class="feature-hover-effect"></div>
              <div class="feature-icon-container">
                <span class="feature-icon">🎨</span>
              </div>
              ...
              <div class="feature-stats">
                <span class="feature-count">支持多维度分析</span>
                <span class="feature-badge">📱动态</span>
              </div>
            </div>

            <!-- 知识结构 -->
            <div class="feature-card floating-card" @click="navigateTo('/student/knowledge-structure')">
              <div class="feature-hover-effect"></div>
              <div class="feature-icon-container">
                <span class="feature-icon">🧩</span>
              </div>
              ...
              <p class="feature-description">
                浏览{{ knowledgeDomains }}个知识领域的完整结构，构建系统化知识体系。
              </p>
              <div class="feature-stats">
          ...
          <div class="knowledge-graph-container">
            ...
            <div class="graph-visualization">
              ...
              <div class="knowledge-nodes">
                <!-- 主节点 -->
                <div class="knowledge-node primary-node" style="top: 40%; left: 20%;">
                  <div class="node-glow"></div>
                  编程语言基础
                </div>
                <div class="knowledge-node primary-node" style="top: 40%; left: 60%;">
                  <div class="node-glow"></div>
                  数据结构与算法
                </div>
                
                <!-- 从节点 -->
                <div class="knowledge-node secondary-node" style="top: 20%; left: 30%;">
                  JavaScript
                </div>
                <div class="knowledge-node secondary-node" style="top: 20%; left: 70%;">
                  数组
                </div>
                <div class="knowledge-node secondary-node" style="top: 60%; left: 30%;">
                  HTML/CSS
                </div>
                <div class="knowledge-node secondary-node" style="top: 60%; left: 70%;">
                  排序算法
                </div>
              ...
              <button class="explore-graph-btn" @click="exploreKnowledgeGraph">
                探索完整图谱
              </button>
            </div>
          </div>
...
const recommendations = reactive([
  {
    ...
    icon: "💻",
    title: "编程入门基础",
    description: "学习编程基础知识，包括变量、数据类型、循环和条件语句等核心概念",
    difficulty: "初级",
    estimatedTime: "45分钟",
  },
  {
    ...
    icon: "🌐",
    title: "前端开发实战",
    description: "学习HTML、CSS和JavaScript基础，完成一个简单响应式网页的开发",
    difficulty: "中等",
    estimatedTime: "60分钟",
  },
  {
