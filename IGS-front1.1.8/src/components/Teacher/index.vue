      ...
      <section v-if="isTeacher">
          ...
          <div class="tasks-container">
            <div v-for="task in pendingTaskList" :key="task.id" class="task-card">
              ...
              <div class="task-actions">
                <button class="action-btn complete-btn" @click="markTaskAsComplete(task.id)">
                  完成
                </button>
                <button class="action-btn view-btn" @click="viewTaskDetails(task.id)">
                  详情
                </button>
              </div>
            </div>
        ...
        <section class="core-features">
          ...
          <div class="features-grid">
            <!-- 班级管理 -->
            <div class="feature-card floating-card" @click="navigateTo('/teacher/class/tracking')">
              ...
              <p class="feature-description">
                管理{{ classCount }}个班级，查看学生表现，发布公告和通知，组织课堂活动。
              </p>
              <div class="feature-stats">
                <span class="feature-count">共{{ studentCount }}名学生</span>
                <span class="feature-badge">📋管理</span>
              </div>
            </div>

            <!-- 习题管理 -->
            <div class="feature-card floating-card" @click="navigateTo('/teacher/exercise/bank')">
              <div class="feature-hover-effect"></div>
              <div class="feature-icon-container">
                <span class="feature-icon">📝</span>
              </div>
              ...
              <div class="feature-stats">
                <span class="feature-count">已上传{{ questionCount }}道题</span>
            ...
            <div class="feature-card floating-card" @click="navigateTo('/teacher/class/tracking')">
              ...
              <div class="feature-stats">
                <span class="feature-count">支持10+种分析维度</span>
                <span class="feature-badge">🔍分析</span>
              </div>
            </div>

            <!-- 智能推荐 -->
            <div class="feature-card floating-card" @click="navigateTo('/teacher/exercise/new')">
              <div class="feature-hover-effect"></div>
              <div class="feature-icon-container">
                <span class="feature-icon">💡</span>
              </div>
                ...
                <div class="chart-grid">
                  ...
                  <div class="chart-x-axis">
                    ...
                    <div class="x-axis-ticks">
                      <div class="x-tick" v-for="cls in classProgressData" :key="cls.id">
                        {{ cls.className }}
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="chart-bars">
                    <div 
                      ...
                      :key="cls.id"
                      :style="{ height: cls.progress + '%' }"
                    >
                      <div class="bar-value">{{ cls.progress }}%</div>
                    </div>
                  </div>
                </div>
              </div>
              <button class="view-details-btn" @click="viewProgressDetails">
                查看详情
              </button>
            </div>
          </div>
            ...
            <div class="teacher-stats-cards">
              ...
              <div id="teacher-accuracy-rate" class="status-card">
                ...
                <div class="card-header">
                  <span class="card-title">班级平均正确率</span>
                ...
                <div class="progress-container">
                  ...
                  <div class="progress-bar" :style="{ width: averageAccuracy + '%' }"></div>
                </div>
                <div class="card-trend">
                  <span class="trend-indicator">+{{ accuracyTrend }}%</span>
                  <span class="trend-text">较上月</span>
                </div>
              </div>

              <!-- 教师状态卡片 - 学习时长 -->
              <div id="teacher-study-duration" class="status-card">
                <div class="card-gradient"></div>
                <div class="card-header">
                ...
                <div class="card-stat">
                  <span class="stat-value">{{ averageStudyHours }}</span>
                  <span class="stat-unit">小时/周</span>
                </div>
                <div class="progress-container">
                  <div class="progress-background"></div>
                  <div class="progress-bar" :style="{ width: studyHoursRateTeacher + '%' }"></div>
                </div>
                <div class="card-trend">
                  <span class="trend-indicator">+{{ hoursTrend }}</span>
                  <span class="trend-text">较上月</span>
                </div>
              </div>

              <!-- 教师状态卡片 - 完成任务 -->
              <div id="teacher-completed-tasks" class="status-card">
                <div class="card-gradient"></div>
                <div class="card-header">
                ...
                <div class="progress-container">
                  <div class="progress-background"></div>
                  <div class="progress-bar" :style="{ width: assignmentCompletionRate + '%' }"></div>
                </div>
                <div class="card-trend">
                  <span class="trend-indicator">+{{ assignmentsTrend }}%</span>
                  <span class="trend-text">较上月</span>
                </div>
              </div>
            </div>
