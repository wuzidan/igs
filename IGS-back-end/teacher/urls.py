...
from .views import (
    TeacherProfileView, TeacherAvatarUploadView, SubjectListView,
    TeacherDashboardView, StudentKnowledgeMasteryView,
)
...
urlpatterns = [
    ...
    path('student-knowledge-mastery/', StudentKnowledgeMasteryView.as_view(), name='student-knowledge-mastery'),
]